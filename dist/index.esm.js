...
var useExponentialBackoff = function (config) {
    ...
    var _f = useState(false), isRetrying = _f[0], setIsRetrying = _f[1];
    var _g = useState(0), retryCount = _g[0], setRetryCount = _g[1];
    var _h = useState(null), lastError = _h[0], setLastError = _h[1];
    var timeoutRef = useRef(null);
    var abortControllerRef = useRef(null);
    var calculateDelay = useCallback(function (attempt) {
    ...
    var executeWithBackoff = useCallback(function (operation, onSuccess, onFailure) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var getNextDelay = useCallback(function () {
